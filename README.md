...
首先 [安装 n8n](https://docs.n8n.io/hosting/)
...
如果你使用的是 n8n desktop 或自建服务，进入 n8n 的 `.n8n/custom/node_modules` 目录下执行上述命令即可。

如果需要手动安装，也可以在 [这里](https://github.com/rnmmr/n8n-nodes-vrchat/releases) 下载最新的 `n8n-nodes-vrchat.zip` 文件，解压到 `C:\Users\你的用户名\.n8n\custom\node_modules\n8n-nodes-vrchat`。
...
1. 登录 [VRChat 官网](https://vrchat.com/home)，打开开发者工具（F12）
2. 点击上方的网络（Network）选项卡，然后按 F5 刷新或等待一会
3. 按照下面的方法查找
